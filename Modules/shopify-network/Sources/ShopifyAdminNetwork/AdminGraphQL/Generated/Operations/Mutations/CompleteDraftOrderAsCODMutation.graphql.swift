...
public extension ShopifyAdminAPI {
  class CompleteDraftOrderAsCODMutation: GraphQLMutation {
    public static let operationName: String = "CompleteDraftOrderAsCOD"
    public static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"mutation CompleteDraftOrderAsCOD($id: ID!, $paymentGatewayId: ID) { draftOrderComplete(id: $id, paymentGatewayId: $paymentGatewayId) { __typename draftOrder { __typename order { __typename id name } } userErrors { __typename message } } }"#
      ))

    public var id: ID
    public var paymentGatewayId: GraphQLNullable<ID>

    public init(
      id: ID,
      paymentGatewayId: GraphQLNullable<ID>
    ) {
      self.id = id
    ...
    public struct Data: ShopifyAdminAPI.SelectionSet {
      ...
      public static var __selections: [ApolloAPI.Selection] { [
        .field("draftOrderComplete", DraftOrderComplete?.self, arguments: [
          "id": .variable("id"),
          "paymentGatewayId": .variable("paymentGatewayId")
        ]),
      ] }
